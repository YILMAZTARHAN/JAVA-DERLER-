   ...
   //Girilen sayilar ve aralarindaki tum tamsayilari toplayip,
	//sonucu yazdiran bir program yaziniz
		 ...
		 Scanner scan = new Scanner(System.in);
	      System.out.println("lutfen aradaki tüm sayýlarý toplamak için iki tam sayý giriniz...");
	     ...
	     System.out.println("Girilen Sayýlar aralarýndaki sayýlarýn toplamý: " + toplam); 
